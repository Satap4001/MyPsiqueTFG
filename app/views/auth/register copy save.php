...
<div class="d-flex" style="min-height: 100vh;">
    ...
    <div class="flex-grow-1 d-flex align-items-center justify-content-center p-4"
        ...
        <div class="card border-0 rounded-4 shadow-sm p-4 p-md-5" style="width: 100%; max-width: 420px;">
            ...
            <form>
                <div class="mb-3">
                    <label for="name" class="form-label fw-medium small" style="color: var(--color-gris-azul-medio);">
                        Nombre completo
                    </label>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-6">
                        <label for="password" class="form-label fw-medium small" style="color: var(--color-gris-azul-medio);">
                            Contraseña
                        </label>
                    ...
                    <div class="col-6">
                        <label for="confirm_password" class="form-label fw-medium small" style="color: var(--color-gris-azul-medio);">
                ...
                <div class="mb-4">
                    <label for="province" class="form-label fw-medium small" style="color: var(--color-gris-azul-medio);">
                        Provincia
                    </label>
                    <input type="text" class="form-control rounded-3" name="province" id="province"
